...
/// @brief 两个组件之间的水平分割，可通过鼠标配置。
/// @param main 大小为 |main_size| 的主组件，位于左侧。
/// @param back 占用剩余大小的后备组件，位于右侧。
/// @param main_size |main| 组件的大小。
/// @ingroup component
///
/// ### Example
///
...
/// @brief 两个组件之间的水平分割，可通过鼠标配置。
/// @param main 大小为 |main_size| 的主组件，位于右侧。
/// @param back 占用剩余大小的后备组件，位于左侧。
/// @param main_size |main| 组件的大小。
/// @ingroup component
///
/// ### Example
...
/// @brief 两个组件之间的垂直分割，可通过鼠标配置。
/// @param main 大小为 |main_size| 的主组件，位于顶部。
/// @param back 占用剩余大小的后备组件，位于底部。
/// @param main_size |main| 组件的大小。
/// @ingroup component
///
/// ### Example
...
/// @brief 两个组件之间的垂直分割，可通过鼠标配置。
/// @param main 大小为 |main_size| 的主组件，位于底部。
/// @param back 占用剩余大小的后备组件，位于顶部。
/// @param main_size |main| 组件的大小。
/// @ingroup component
///
/// ### Example
