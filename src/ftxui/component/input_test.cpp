...
#include "ftxui/component/component.hpp"       // 用于 Input
#include "ftxui/component/component_base.hpp"  // 用于 ComponentBase, Component
#include "ftxui/component/component_options.hpp"  // 用于 InputOption
#include "ftxui/component/event.hpp"  // 用于 Event, Event::ArrowRightCtrl, Event::ArrowLeftCtrl, Event::ArrowLeft, Event::ArrowRight, Event::ArrowDown, Event::ArrowUp, Event::Delete, Event::Backspace, Event::Return, Event::End, Event::Home
#include "ftxui/component/mouse.hpp"  // 用于 Mouse, Mouse::Button, Mouse::Left, Mouse::Motion, Mouse::Pressed
#include "ftxui/dom/elements.hpp"   // 用于 Fit
#include "ftxui/dom/node.hpp"       // 用于 Render
#include "ftxui/screen/screen.hpp"  // 用于 Fixed, Screen, Pixel
#include "ftxui/util/ref.hpp"       // 用于 Ref
#include "gtest/gtest.h"  // 用于 AssertionResult, Message, TestPartResult, EXPECT_EQ, EXPECT_TRUE, Test, EXPECT_FALSE, TEST
