...
class ButtonBase : public ComponentBase, public ButtonOption {
 public:
  ...
  void OnClick() {
    ...
    // TODO(arthursonzogni): Considerar publicar la tarea en el bucle principal, en lugar
    // de invocarla inmediatamente.
...
/// @brief Dibuja un botón. Ejecuta una función al hacer clic.
...
/// @param on_click La acción a ejecutar al hacer clic.
/// @param option Parámetros opcionales adicionales.
/// @ingroup component
/// @see ButtonBase
///
