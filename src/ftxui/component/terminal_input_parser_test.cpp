...
// Prueba el carácter |c| para que se convierta trivialmente en |Event::Character(c)|.
...
TEST(Event, UTF8) {
  struct {
    ...
    bool valid;
      ...
      // Límites de prueba entre las distintas regiones legales
      // https://unicode.org/versions/corrigendum1.html
      // Límite entre lo válido y lo inválido
...
TEST(Event, Special) {
  ...
  struct {
    ...
    Event expected;
      ...
      // Flecha (modo de cursor predeterminado)
      {str("[A"), Event::ArrowUp},
      ...
      // Flecha (modo de cursor de aplicación)
      ...
      // Teclas de función      {str("\x1BOP"), Event::F1},
      {str("\x1BOQ"), Event::F2},
      {str("\x1BOR"), Event::F3},
      {str("\x1BOS"), Event::F4},
      {str("\x1B[15~"), Event::F5},
      ...
      // Teclas de función para terminal virtual:
      {str("\x1B[[A"), Event::F1},
      {str("\x1B[[B"), Event::F2},
      {str("\x1B[[C"), Event::F3},
      {str("\x1B[[D"), Event::F4},
      ...
      // Teclas de función para xterm-r5, xterm-r6, rxvt
      {str("\x1B[11~"), Event::F1},
      {str("\x1B[12~"), Event::F2},
      {str("\x1B[13~"), Event::F3},
      {str("\x1B[14~"), Event::F4},

      // Teclas de función para vt100
      {str("\x1BOt"), Event::F5},
      {str("\x1BOu"), Event::F6},
      {str("\x1BOv"), Event::F7},
      {str("\x1BOl"), Event::F8},
      ...
      // Teclas de función para scoansi
      {str("\x1B[M"), Event::F1},
      {str("\x1B[N"), Event::F2},
      {str("\x1B[O"), Event::F3},
      {str("\x1B[P"), Event::F4},
