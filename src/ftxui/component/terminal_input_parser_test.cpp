...
// |c| の文字が |Event::Character(c)| に自明に変換されることをテストします。
  ...
  struct {
    ...
    Event expected;
      ...
      {str("\x1B[23~"), Event::F11},
                ...
                // 仮想ターミナル用のファンクションキー:
                {str("\x1B[[A"), Event::F1},      {str("\x1B[[B"), Event::F2},
      {str("\x1B[[C"), Event::F3},
      {str("\x1B[[D"), Event::F4},
                {str("\x1B[[E"), Event::F5},
      
                // xterm-r5, xterm-r6, rxvt 用のファンクションキー
                {str("\x1B[11~"), Event::F1},      {str("\x1B[12~"), Event::F2},
      {str("\x1B[13~"), Event::F3},
                {str("\x1B[14~"), Event::F4},
      
                // vt100 用のファンクションキー
                {str("\x1BOt"), Event::F5},      {str("\x1BOu"), Event::F6},
      {str("\x1BOv"), Event::F7},
      {str("\x1BOl"), Event::F8},
      {str("\x1BOw"), Event::F9},
                {str("\x1BOx"), Event::F10},
                ...
                // scoansi 用のファンクションキー
                {str("\x1B[M"), Event::F1},      {str("\x1B[N"), Event::F2},
      {str("\x1B[O"), Event::F3},
      {str("\x1B[P"), Event::F4},
      {str("\x1B[Q"), Event::F5},
      {str("\x1B[R"), Event::F6},
