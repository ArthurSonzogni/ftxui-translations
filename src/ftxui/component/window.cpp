...
#include <memory>
#include <utility>
#include "ftxui/dom/elements.hpp"  // pour text, window, hbox, vbox, size, clear_under, reflect, emptyElement
...
class WindowImpl : public ComponentBase, public WindowOptions {
 ...
 private:
  Element OnRender() final {
    ...
    // Positionne et enregistre la zone dessinée de la fenêtre.
  ...
  bool OnEvent(Event event) final {
    ...
    // Glisser uniquement si nous ne redimensionnons pas encore une bordure :
...
/// @brief Une fenêtre déplaçable / redimensionnable. Pour en utiliser plusieurs, elles doivent
/// être empilées à l'aide du composant `Container::Stacked({...})`;
///
