...
/// @brief Un curseur horizontal.
/// @param label Le nom du curseur.
/// @param value La valeur actuelle du curseur.
/// @param min La valeur minimale.
/// @param max La valeur maximale.
/// @param increment L'incrément lors de l'utilisation par le curseur.
/// @ingroup component
///
/// ### Exemple
///
...
/// @brief Un curseur dans n'importe quelle direction.
