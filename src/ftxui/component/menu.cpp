...
/// @brief 元素的水平列表。使用者可以在其中導航。
/// @param entries 要顯示的可選條目列表。
/// @param selected 參考選定的條目。
/// 另請參閱 |Menu|。
/// @ingroup component
...
/// @brief 一個特定的菜單條目。它們可以放入 Container::Vertical 中以形成菜單。
/// @param label 表示此元素的繪製文本。
/// @param option 額外的可選參數。
/// @ingroup component
///
/// ### 範例
