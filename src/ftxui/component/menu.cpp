...
/// @brief Una lista de elementos. El usuario puede navegar a través de ellos.
/// @ingroup component
...
/// @brief Una lista de texto. El elemento enfocado está seleccionado.
/// @param option una estructura que contiene todos los parámetros.
/// @ingroup component
///
/// ### Ejemplo
///
...
/// @brief Una lista de texto. El elemento enfocado está seleccionado.
/// @param entries La lista de entradas en el menú.
...
/// @brief Una lista horizontal de elementos. El usuario puede navegar a través de ellos.
/// @param entries La lista de entradas seleccionables a mostrar.
/// @param selected Referencia la entrada seleccionada.
/// Ver también |Menu|.
/// @ingroup component
...
/// @brief Una entrada de menú específica. Se pueden colocar en un Container::Vertical para
/// formar un menú.
/// @param label El texto dibujado que representa este elemento.
/// @param option Parámetros opcionales adicionales.
/// @ingroup component
///
/// ### Ejemplo
