...
/// @brief Une liste d'éléments. L'utilisateur peut naviguer à travers eux.
/// @ingroup component
...
/// @brief Une liste de texte. L'élément sélectionné est mis en évidence.
...
/// @brief Une liste horizontale d'éléments. L'utilisateur peut naviguer à travers eux.
/// @param entries La liste des entrées sélectionnables à afficher.
/// @param selected Référence l'entrée sélectionnée.
/// Voir aussi |Menu|.
/// @ingroup component
...
/// former un menu.
/// @param label Le texte affiché représentant cet élément.
/// @param option Paramètres optionnels supplémentaires.
/// @ingroup component
///
/// ### Exemple
