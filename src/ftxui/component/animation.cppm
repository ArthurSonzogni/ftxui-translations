...
/// @brief Interface du module C++20 pour le namespace Animation du module Component.
///
module;
 ...
 * @brief Le namespace FTXUI ftxui::animation::
 */
export namespace ftxui::animation {
    ...
    /**
     * @namespace easing
     * @brief Le namespace FTXUI ftxui::animation::easing::
     */
    namespace easing {
