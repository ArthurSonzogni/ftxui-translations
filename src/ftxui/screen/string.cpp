...
// À partir de la chaîne encodée UTF8 |input|, consomme entre 1 et 4 octets
// représentant un point de code. Place le point de code dans |ucs|. Commence
// à |start| et met à jour |end| pour représenter le début du prochain octet
// à consommer pour les exécutions consécutives.
...
// À partir de la chaîne encodée UTF16 |input|, consomme entre 1 et 4 octets
// représentant un point de code. Place le point de code dans |ucs|. Commence
// à |start| et met à jour |end| pour représenter le début du prochain octet
// à consommer pour les exécutions consécutives.
