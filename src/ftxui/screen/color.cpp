...
/// @brief Construit une couleur transparente.
Color::Color() = default;

/// @brief Construit une couleur transparente.
Color::Color(Palette1 /*value*/) : Color() {}

/// @brief Construit une couleur en utilisant les couleurs de la Palette16.
Color::Color(Palette16 index)
    : type_(ColorType::Palette16), red_(index), alpha_(255) {}

/// @brief Construit une couleur en utilisant les couleurs de la Palette256.
...
/// @brief Construit une couleur à partir de sa représentation RGB.
/// https://en.wikipedia.org/wiki/RGB_color_model
///
/// @param red La quantité de rouge [0,255]
/// @param green La quantité de vert [0,255]
/// @param blue La quantité de bleu [0,255]
/// @param alpha La quantité d'alpha [0,255]
...
/// @brief Construit une couleur à partir de sa représentation RGBA.
/// https://en.wikipedia.org/wiki/RGB_color_model
/// @param red La quantité de rouge [0,255]
/// @param green La quantité de vert [0,255]
/// @param blue La quantité de bleu [0,255]
...
/// @brief Construit une couleur à partir de sa représentation HSV.
/// https://en.wikipedia.org/wiki/HSL_and_HSV
///
/// @param h La teinte de la couleur [0,255]
/// @param s La "saturation" [0,255].
/// @param v La "luminosité" [0,255]
/// @param alpha La quantité d'alpha [0,255]
// static
...
Color Color::Interpolate(float t, const Color& a, const Color& b) {
  ...
  // Correction gamma:
  // https://en.wikipedia.org/wiki/Gamma_correction  auto interp = [t](uint8_t a_u, uint8_t b_u) {
...
/// @brief Mélange deux couleurs en utilisant le canal alpha.
// static
