...
#include "ftxui/screen/color_info.hpp"  // 用於 GetColorInfo, ColorInfo
#include "ftxui/screen/terminal.hpp"  // 用於 ColorSupport, Color, Palette256, TrueColor
...
/// @brief 從 RGB 表示建立一個顏色。
/// https://en.wikipedia.org/wiki/RGB_color_model
///
/// @param red 紅色的量 [0,255]
/// @param green 綠色的量 [0,255]
/// @param blue 藍色的量 [0,255]
/// @param alpha alpha 的量 [0,255]
