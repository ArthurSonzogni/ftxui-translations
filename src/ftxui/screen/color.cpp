...
/// @brief Construye un color transparente.
Color::Color() = default;

/// @brief Construye un color transparente.
Color::Color(Palette1 /*value*/) : Color() {}

/// @brief Construye un color usando los colores de la Paleta16.
Color::Color(Palette16 index)
    : type_(ColorType::Palette16), red_(index), alpha_(255) {}

/// @brief Construye un color usando los colores de la Paleta256.
...
/// @brief Construye un Color a partir de su representación RGB.
/// https://en.wikipedia.org/wiki/RGB_color_model
///
/// @param red La cantidad de rojo [0,255]
/// @param green La cantidad de verde [0,255]
/// @param blue La cantidad de azul [0,255]
/// @param alpha La cantidad de alfa [0,255]
...
/// @brief Construye un Color a partir de su representación RGBA.
/// https://en.wikipedia.org/wiki/RGB_color_model
/// @param red La cantidad de rojo [0,255]
/// @param green La cantidad de verde [0,255]
/// @param blue La cantidad de azul [0,255]
...
/// @brief Construye un Color a partir de su representación HSV.
/// https://en.wikipedia.org/wiki/HSL_and_HSV
///
/// @param h El tono del color [0,255]
/// @param s La "saturación" [0,255].
/// @param v La "luminosidad" [0,255]
/// @param alpha La cantidad de alfa [0,255]
// static
...
/// @brief Mezcla dos colores usando el canal alfa.
// static
