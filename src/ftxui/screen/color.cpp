...
/// @brief ANSIカラーコードを文字列に追加する(ゼロアロケーションの高速パス)。
/// @param out 追加先の文字列。
/// @param is_background_color これが背景色コードかどうか。
...
/// @brief Palette256の色を使用して色を構築します。
...
/// @brief RGB表現から色を構築します。
/// https://en.wikipedia.org/wiki/RGB_color_model
///
/// @param red 赤の量 [0,255]
/// @param green 緑の量 [0,255]
/// @param blue 青の量 [0,255]
/// @param alpha アルファの量 [0,255]
...
/// @brief アルファチャンネルを使用して2つの色をブレンドします。
// static
