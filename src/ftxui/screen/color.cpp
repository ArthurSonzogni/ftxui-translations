...
#include <array>  // 用于 array
#include <cmath>
#include <cstdint>
#include <string>

#include "ftxui/screen/color_info.hpp"  // 用于 GetColorInfo, ColorInfo
#include "ftxui/screen/terminal.hpp"  // 用于 ColorSupport, Color, Palette256, TrueColor
