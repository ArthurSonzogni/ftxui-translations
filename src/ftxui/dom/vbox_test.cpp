...
// 本源代码的使用受 MIT 许可证约束，该许可证可在
// LICENSE 文件中找到。
#include <gtest/gtest.h>
  std::algorithm;  // 用于移除
#include <cstddef>    // 用于 size_t
     // 用于 string, allocator, basic_string
#include <vector>     // 用于 vector

#include "ftxui/dom/elements.hpp"  // 用于 vtext, operator|, vbox, Element, flex_grow, flex_shrink
  "ftxui/dom/node.hpp"       // 用于 Render
  "ftxui/screen/screen.hpp"  // 用于 Screen
