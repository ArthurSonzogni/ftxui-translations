...
// LICENSE 文件。
#include <gtest/gtest.h>  // 用于 Test, TestInfo (仅限指针), EXPECT_EQ, Message, TEST, TestPartResult
#include <array>          // 用于 array
#include <cstddef>        // 用于 size_t
#include <queue>
#include <stack>          // 用于 stack
#include <string>         // 用于 allocator, basic_string, string
#include <unordered_set>  // 用于 unordered_set
#include <vector>         // 用于 vector

#include "ftxui/dom/elements.hpp"  // 用于 text, operator|, Element, flex_grow, flex_shrink, hbox
