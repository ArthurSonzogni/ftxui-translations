...
// Resolver índices negativos como contados desde el final.
...
void Table::Initialize(std::vector<std::vector<Element>> input) {
  ...
  // Transferir elements_ desde |input| hacia |elements_|.
  {
    int y = 1;
    for (auto& row : input) {
      int x = 1;
  ...
  // Añadir elemento vacío para el borde.
  for (int y = 0; y < dim_y_; ++y) {
...
TableSelection Table::SelectRectangle(int column_min,
  ...
  // Los índices fuera de rango no seleccionan nada.
...
/// @brief Aplica el `decorator` al borde de la selección.
/// @param decorator El decorador a aplicar.
...
/// @brief Aplica el `decorator` al borde izquierdo de la selección.
/// @param decorator El decorador a aplicar.
...
/// @brief Aplica el `decorator` al borde derecho de la selección.
/// @param decorator El decorador a aplicar.
...
/// @brief Aplica el `decorator` al borde superior de la selección.
/// @param decorator El decorador a aplicar.
...
/// @brief Aplica el `decorator` al borde inferior de la selección.
/// @param decorator El decorador a aplicar.
...
/// @brief Aplica el `decorator` a los separadores de la selección.
/// @param decorator El decorador a aplicar.
...
/// @brief Aplica el `decorator` a los separadores verticales de la selección.
/// @param decorator El decorador a aplicar.
...
/// @brief Aplica el `decorator` a los separadores horizontales de la selección.
/// @param decorator El decorador a aplicar.
...
/// @brief Dibuja algunas líneas separadoras al lado izquierdo de la selección.
/// @param border El estilo de borde a aplicar.
/// @param decorator El decorador a aplicar.
void TableSelection::BorderLeft(BorderStyle border,
                                const Decorator& decorator) {
...
/// @brief Dibuja algunas líneas separadoras al lado derecho de la selección.
/// @param border El estilo de borde a aplicar.
/// @param decorator El decorador a aplicar.
void TableSelection::BorderRight(BorderStyle border,
                                 const Decorator& decorator) {
...
/// @brief Dibuja algunas líneas separadoras en el lado superior de la selección.
/// @param border El estilo de borde a aplicar.
/// @param decorator El decorador a aplicar.
...
/// @brief Dibuja algunas líneas separadoras en el lado inferior de la selección.
/// @param border El estilo de borde a aplicar.
/// @param decorator El decorador a aplicar.
void TableSelection::BorderBottom(BorderStyle border,
                                  const Decorator& decorator) {
