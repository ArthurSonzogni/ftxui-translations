...
void Table::Initialize(std::vector<std::vector<Element>> input) {
  ...
  // |input|から|elements_|へelements_を転送する。
  {
    int y = 1;
    for (auto& row : input) {
      int x = 1;
...
/// @brief 選択範囲の枠線に`decorator`を適用する。
/// @param decorator 適用するデコレータ。
...
/// @brief 選択範囲の左枠線に`decorator`を適用する。
/// @param decorator 適用するデコレータ。
...
/// @brief 選択範囲の右枠線に`decorator`を適用する。
/// @param decorator 適用するデコレータ。
...
/// @brief 選択範囲の上枠線に`decorator`を適用する。
/// @param decorator 適用するデコレータ。
...
/// @brief 選択範囲の下枠線に`decorator`を適用する。
/// @param decorator 適用するデコレータ。
...
/// @brief 選択範囲のセパレーターに`decorator`を適用する。
/// @param decorator 適用するデコレータ。
...
/// @brief 選択範囲の垂直セパレーターに`decorator`を適用する。
/// @param decorator 適用するデコレータ。
...
/// @brief 選択範囲の水平セパレーターに`decorator`を適用する。
/// @param decorator 適用するデコレータ。
...
/// @brief 選択範囲の周りに`border`を適用する。
/// @param border 適用する枠線スタイル。
/// @param decorator 適用するデコレータ。
