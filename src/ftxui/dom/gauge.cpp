...
static const std::string charset_horizontal[11] = {
    ...
    // Les terminaux Microsoft utilisent souvent des polices ne gérant pas les 8
    // caractères Unicode pour représenter la jauge complète. Repli avec moins.    " ", " ", " ", " ", "▌", "▌", "▌", "█", "█", "█",
#else
    " ", " ", "▏", "▎", "▍", "▌", "▋", "▊", "▉", "█",
#endif
    // Un caractère supplémentaire au cas où le fuzzer parviendrait à avoir :
...
/// @brief Dessine une barre de progression haute définition progressant dans la
/// direction spécifiée.
...
/// @brief Dessine une barre de progression haute définition progressant de
/// gauche à droite.
/// @param progress La proportion de la zone à remplir. Appartient à [0,1].
///
/// ### Exemple
...
/// @brief Dessine une barre de progression haute définition.
/// @param progress La proportion de la zone à remplir. Appartient à [0,1].
/// @ingroup dom
///
/// ### Exemple
