...
/// @brief コンテナに残されたスペースに比例して拡大する要素。
/// @ingroup dom
Element filler() {
  return std::make_shared<Flex>(function_flex);
}

/// @brief 子要素をコンテナに残されたスペースに比例して拡大させます。
/// @ingroup dom
///
/// #### Examples:
///
