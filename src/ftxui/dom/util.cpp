...
/// @brief Una decoración que no hace absolutamente nada.
/// @ingroup dom
Element nothing(Element element) {
  return element;
}

/// @brief Compone dos decoradores en uno.
/// @ingroup dom
///
/// ### Ejemplo
///
...
/// @brief A partir de un conjunto de elementos, aplica un decorador a cada elemento.
/// @return el conjunto de elementos decorados.
/// @ingroup dom
...
/// @brief A partir de un elemento, aplica un decorador.
/// @return el elemento decorado.
/// @ingroup dom
///
/// ### Ejemplo
///
...
/// @brief Aplica un decorador a un elemento.
/// @return el elemento decorado.
/// @ingroup dom
///
/// ### Ejemplo
...
/// La dimensión mínima que se ajustará al elemento dado.
/// @see Fixed
/// @see Full
