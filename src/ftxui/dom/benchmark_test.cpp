...
#include "ftxui/dom/elements.hpp"  // 用于 gauge, separator, operator|, text, Element, hbox, vbox, blink, border, inverted
...
BENCHMARK(BenchmarkStyle)
    ->ArgsProduct({
        benchmark::CreateDenseRange(1, 10, 3),     // 元素数量。
        benchmark::CreateDenseRange(10, 200, 20),  // 屏幕宽度。
    });
