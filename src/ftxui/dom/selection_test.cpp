...
#include <csignal>  // para raise, SIGABRT, SIGFPE, SIGILL, SIGINT, SIGSEGV, SIGTERM

#include "ftxui/component/component.hpp"  // para Input, Renderer, Vertical
#include "ftxui/component/event.hpp"      // para Event
#include "ftxui/component/loop.hpp"       // para Loop
#include "ftxui/component/mouse.hpp"  // para Mouse, Mouse::Left, Mouse::Pressed, Mouse::Released
#include "ftxui/component/screen_interactive.hpp"
#include "ftxui/dom/elements.hpp"   // para text
#include "ftxui/dom/node.hpp"       // para Render
#include "ftxui/screen/screen.hpp"  // para Screen
...
// Verifica que el envío rápido de múltiples eventos de ratón no active múltiples
