...
#include <gtest/gtest.h>  // Test、EXPECT_EQ、Message、TestPartResult、TestInfo (ptrのみ)、TEST用
#include <ftxui/dom/linear_gradient.hpp>  // LinearGradient::Stop、LinearGradient用

#include "ftxui/dom/elements.hpp"  // operator|、text、bgcolor、color、Element用
#include "ftxui/dom/node.hpp"      // Render用
#include "ftxui/screen/color.hpp"   // Color、Color::RedLight、Color::Red用
#include "ftxui/screen/screen.hpp"  // Screen、Pixel用
