...
std::vector<std::vector<ftxui::ColorInfo>> ColorInfoSorted2D() {
  // Acquérir les informations de couleur pour la palette256.
  ...
  // Minimiser les discontinuités pour chaque colonne.
