...
std::vector<std::vector<ftxui::ColorInfo>> ColorInfoSorted2D() {
  // Adquirir la información de color para la paleta256.
  ...
  // Minimizar discontinuidades para cada columna.
