...
struct FTXUI_EXPORT(DOM) Canvas {
 ...
 private:
  ...
  enum CellType {
    kCell,     // Unidades de tamaño 2x4
    kBlock,    // Unidades de tamaño 2x2
    kBraille,  // Unidades de tamaño 1x1
  };
