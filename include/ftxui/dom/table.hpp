...
class FTXUI_EXPORT(DOM) TableSelection {
 public:
  // Decora toda la selección con un decorador.
  ...
  // Decora solo las celdas de la selección con un decorador.
  ...
  // Decora solo el borde de la selección con un decorador.
  ...
  // Decora solo el separador de la selección con un decorador.
  ...
  // Decora el borde de la selección con un estilo de borde y un decorador.
  ...
  // Decora el separador de la selección con un estilo de borde y un
  // decorador.
