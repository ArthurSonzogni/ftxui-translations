...
#ifdef RGB
// 解决 wingdi.h（通过 Windows.h）定义破坏性宏的问题。
...
class Color {
 public:
  ...
  Color(Palette16 index);   // 从索引到颜色的隐式转换。
  Color(Palette256 index);  // 从索引到颜色的隐式转换。
  // NOLINTEND
