...
class Color {
 public:
  ...
  // NOLINTBEGIN
  Color();                  // Transparente.
  Color(Palette1 index);    // Transparente.
  Color(Palette16 index);   // Conversión implícita de índice a Color.
  Color(Palette256 index);  // Conversión implícita de índice a Color.
  // NOLINTEND
